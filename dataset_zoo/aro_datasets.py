...
class VL_Checklist_Relation(Dataset):
    def __init__(self, image_preprocess, text_perturb_fn=None, image_perturb_fn=None, root_dir=ARO_ROOT, download=False):
        ...
        '''
        self.root_dir = root_dir
        annotation_file = os.path.join(root_dir, "vl_checklist_relations.json")
        image_dir = "replace/data/"
...
class VL_Checklist_Object(Dataset):
    def __init__(self, image_preprocess, text_perturb_fn=None, image_perturb_fn=None, root_dir=ARO_ROOT, download=False):
        ...
        '''
        self.root_dir = root_dir
        annotation_file = os.path.join(root_dir, "vl_checklist_objects.json")
        image_dir = "replace/data/"
...
class VL_Checklist_Attribute(Dataset):
    def __init__(self, image_preprocess, text_perturb_fn=None, image_perturb_fn=None, root_dir=ARO_ROOT, download=False):
        ...
        '''
        self.root_dir = root_dir
        annotation_file = os.path.join(root_dir, "vl_checklist_attributes.json")
        image_dir = "replace/data/"
...
class CREPE_COCO_Negate(Dataset):
    def __init__(self, image_preprocess, text_perturb_fn=None, image_perturb_fn=None, root_dir=ARO_ROOT, download=False):
        '''
        image_preprocess: a function that takes in a PIL image and returns a tensor.
        text_perturb_fn: Not used for this dataset. Just for compatibility with other datasets.
        ...
        '''
        self.root_dir = root_dir
        annotation_file = os.path.join(root_dir, "crepe_coco_val_relations.json")
        image_dir = "negate/data/"
...
def get_vl_checklist_relation(image_preprocess, text_perturb_fn=None, image_perturb_fn=None, download=False):
    return VL_Checklist_Relation(image_preprocess=image_preprocess, text_perturb_fn=text_perturb_fn, image_perturb_fn=image_perturb_fn, download=download)

def get_vl_checklist_attribute(image_preprocess, text_perturb_fn=None, image_perturb_fn=None, download=False):
    return VL_Checklist_Attribute(image_preprocess=image_preprocess, text_perturb_fn=text_perturb_fn, image_perturb_fn=image_perturb_fn, download=download)

def get_vl_checklist_object(image_preprocess, text_perturb_fn=None, image_perturb_fn=None, download=False):
    return VL_Checklist_Object(image_preprocess=image_preprocess, text_perturb_fn=text_perturb_fn, image_perturb_fn=image_perturb_fn, download=download)



def get_crepe_coco_negate(image_preprocess, text_perturb_fn=None, image_perturb_fn=None, download=False):
    return CREPE_COCO_Negate(image_preprocess=image_preprocess, text_perturb_fn=text_perturb_fn, image_perturb_fn=image_perturb_fn, download=download)
